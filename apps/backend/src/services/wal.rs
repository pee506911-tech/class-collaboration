...
impl WalOpType {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ApplySlideOperations => "apply_slide_operations",
            Self::SyncSlides => "sync_slides",
...
impl std::str::FromStr for WalOpType {
    ...
    fn from_str(value: &str) -> Result<Self> {
        match value {
            ...
            "update_slides_batch" => Ok(Self::UpdateSlidesBatch),
            "apply_slide_operations" => Ok(Self::ApplySlideOperations),
            "sync_slides" => Ok(Self::SyncSlides),
...
mod tests {
    ...
    fn wal_op_type_roundtrip() {
        for op in [
            ...
            WalOpType::ApplySlideOperations,
